      ...
      <div className="flex flex-col gap-3 p-4 md:p-6 border-b border-gray-800 shrink-0">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`px-3 md:px-4 py-2 rounded-lg transition-all font-medium text-sm md:text-base ${
              galleryFilter === "all"
          ...
          <button
            ...
            className={`px-3 md:px-4 py-2 rounded-lg transition-all font-medium flex items-center gap-1.5 text-sm md:text-base ${
              galleryFilter === "ai"
                ? "bg-[#DC569D] text-white"
                : "bg-[#2f2f2f] text-gray-400 hover:bg-[#3a3a3a] hover:text-white"
            }`}
