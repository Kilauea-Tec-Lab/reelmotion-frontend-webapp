...
const content = {
  en: {
    ...
    s1_1items: [
      <>
        <strong className="text-gray-200">Account details:</strong> Name, email
        address, password, payment details.
      </>,
      <>
        <strong className="text-gray-200">Uploaded content:</strong> Media,
        text, or prompts you provide to generate AI content.
      </>,
      <>
        <strong className="text-gray-200">Communications:</strong> Emails,
    ...
    s1_2items: [
      <>
        <strong className="text-gray-200">Usage data:</strong> IP address,
        device type, browser, operating system, and interaction logs.
      </>,
      <>
        <strong className="text-gray-200">Cookies & tracking:</strong> We use
        cookies, analytics tools, and similar technologies to improve services.
      </>,
    ],
    s1_3: "AI-Generated and Processed Data",
    s1_3p:
      "Any content you create or upload may be stored temporarily or permanently for:",
    s1_3items: [
      "Service delivery",
    ...
    s3items: [
      <>
        <strong className="text-gray-200">Contractual necessity:</strong> To
        deliver services you request.
      </>,
      <>
        <strong className="text-gray-200">Legitimate interests:</strong> To
        improve security, detect misuse, and enhance features.
      </>,
      <>
        <strong className="text-gray-200">Legal obligation:</strong> To comply
        with applicable laws and regulations.
      </>,
      <>
        <strong className="text-gray-200">Consent:</strong> Where required
        (e.g., for marketing or optional cookies).
      </>,
    ],
    ...
    s4items: [
      <>
        <strong className="text-gray-200">Service providers:</strong> Payment
        processors, cloud storage, analytics tools.
      </>,
      <>
        <strong className="text-gray-200">Legal authorities:</strong> Where
        required by law or court order.
      </>,
      <>
        <strong className="text-gray-200">Business transfers:</strong> In the
    ...
    s8note: (
      <>
        ...
        <strong className="text-white">support@reelmotion.ai</strong>. We will
  ...
  es: {
    ...
    intro1: (
      <>
        <strong className="text-white">Reel Me In Media Limited</strong> respeta
        su privacidad y está comprometida con la protección de sus datos
        personales. Esta Política de Privacidad explica cómo recopilamos,
        usamos, almacenamos y compartimos su información cuando utiliza
        Reelmotion AI.
      </>
    ),
    intro2:
    ...
    s1_1items: [
      <>
        <strong className="text-gray-200">Datos de cuenta:</strong> Nombre,
        dirección de correo electrónico, contraseña, datos de pago.
      </>,
      <>
        <strong className="text-gray-200">Contenido subido:</strong> Medios,
        texto o prompts que proporciona para generar contenido con IA.
      </>,
      <>
        <strong className="text-gray-200">Comunicaciones:</strong> Correos
        electrónicos, mensajes o comentarios que nos envía.
      </>,
    ],
    s1_2: "Información que Recopilamos Automáticamente",
    s1_2items: [
      <>
        <strong className="text-gray-200">Datos de uso:</strong> Dirección IP,
        tipo de dispositivo, navegador, sistema operativo y registros de
        interacción.
      </>,
      <>
        <strong className="text-gray-200">Cookies y rastreo:</strong> Usamos
        cookies, herramientas de análisis y tecnologías similares para mejorar
        los servicios.
      </>,
    ],
    s1_3: "Datos Generados y Procesados por IA",
    s1_3p:
      "Cualquier contenido que cree o suba puede almacenarse temporal o permanentemente para:",
    s1_3items: [
    ...
    s3items: [
      <>
        <strong className="text-gray-200">Necesidad contractual:</strong> Para
        prestar los servicios que solicita.
      </>,
      <>
        <strong className="text-gray-200">Intereses legítimos:</strong> Para
        mejorar la seguridad, detectar uso indebido y mejorar funciones.
      </>,
      <>
        <strong className="text-gray-200">Obligación legal:</strong> Para
        cumplir con las leyes y regulaciones aplicables.
      </>,
      <>
        <strong className="text-gray-200">Consentimiento:</strong> Cuando sea
        necesario (por ejemplo, para marketing o cookies opcionales).
      </>,
    ],
    ...
    s4items: [
      <>
        <strong className="text-gray-200">Proveedores de servicios:</strong>{" "}
        Procesadores de pago, almacenamiento en la nube, herramientas de
        análisis.
      </>,
      <>
        <strong className="text-gray-200">Autoridades legales:</strong> Cuando
        lo requiera la ley u orden judicial.
      </>,
      <>
        <strong className="text-gray-200">Transferencias comerciales:</strong>{" "}
    ...
    s6note:
      "Puede solicitar la eliminación de su cuenta y datos en cualquier momento (ver Sección 8).",
    ...
    s8note: (
      <>
        ...
        <strong className="text-white">support@reelmotion.ai</strong>.
    ...
    s9note:
      "Puede controlar las cookies a través de la configuración de su navegador, pero deshabilitarlas puede afectar la funcionalidad.",
...
export default function PrivacyPage() {
  ...
  return (
    <div className="bg-[#0C0C0D] text-white">
      <SEO
        title="Privacy Policy — Reelmotion AI"
        description="Privacy Policy for Reelmotion AI. Learn how we collect, use, and protect your personal data on our AI content creation platform."
        url="https://reelmotion.ai/privacy"
        lang={locale}
      />
      {/* Top bar */}
      ...
      <div className="max-w-3xl mx-auto px-6 pb-24 space-y-10">
        ...
        <Section number="1" title={t.s1}>
          ...
          <h3 className="text-base font-medium text-gray-200 mt-4">
            <span className="text-gray-500 font-mono text-sm mr-1">1.1</span>{" "}
            {t.s1_1}
          </h3>
          <ul className="list-disc ml-6 space-y-2">
            {t.s1_1items.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
          <h3 className="text-base font-medium text-gray-200 mt-4">
            <span className="text-gray-500 font-mono text-sm mr-1">1.2</span>{" "}
            {t.s1_2}
          </h3>
          <ul className="list-disc ml-6 space-y-2">
            {t.s1_2items.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
          <h3 className="text-base font-medium text-gray-200 mt-4">
            <span className="text-gray-500 font-mono text-sm mr-1">1.3</span>{" "}
            {t.s1_3}
          </h3>
          <p>{t.s1_3p}</p>
          <ul className="list-disc ml-6 space-y-2">
            {t.s1_3items.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
        </Section>
